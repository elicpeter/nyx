...
Phase 11 (cross-function container identity) is expected to strengthen
the underlying heap-aliasing model so that cross-file variants also
work reliably.  Those cross-file variants are out of scope for this
fixture.
